...
;
var list = catsGroupGenerate(30);

function catsGender(arg) {
  var g = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Male";
  var cats = [];
...
console.log(catsName(list)); //# sourceMappingURL=Task 4.js.map
